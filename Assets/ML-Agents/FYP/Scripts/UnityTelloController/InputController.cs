...
namespace UnityControllerForTello
{
    ...
    {
        public enum InputType { Thrustmaster16000, Keyboard, Rift, ThrustmasterThrottle, NeuralNetwork }
        ...
        public float speed;
        public GameObject droneagentobject;
        private DroneAgent agentscript;

        Transform flipArrow;
        SceneManager sceneManager;
        //public telloagent agent;
        ...
        public void CustomAwake(SceneManager sceneManager)
        {
            ...
            agentscript = droneagentobject.GetComponent <DroneAgent>();
        }
        ...
        {          
            ...
            switch (inputType)
            {
                ...
                case InputType.Rift:
                    ...
                    break;
                case InputType.NeuralNetwork:
                    lx = agentscript.rawYaw;
                    rx = agentscript.rawRoll;
                    ry = agentscript.rawPitch;
                    ly = agentscript.rawElv;
                    break;
            }
            if (speed == 0)
            {
